...
-- m and ef_construction are declared, not defaulted: left alone pgvector builds
-- at ef_construction = 64 and Elasticsearch at 100, which is a different graph on
